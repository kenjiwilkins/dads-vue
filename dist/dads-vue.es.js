...
const p = ["disabled"], S = /* @__PURE__ */ r({
  ...
  setup(e, { emit: a }) {
    ...
    return (v, i) => (t(), d("button", {
      class: u(l.value),
      disabled: s.disabled ? "true" : "false",
      onClick: i[0] || (i[0] = (I) => n("onClick"))
    }, [
      o(v.$slots, "default")
    ], 10, p));
  }
  ...
  setup(e) {
    const a = e;
    return c(() => ({
      "dads-h1": a.variant === "h1",
      "dads-h2": a.variant === "h2",
      "dads-h3": a.variant === "h3",
      "dads-h4": a.variant === "h4",
      "dads-h5": a.variant === "h5",
      "dads-body": a.variant === "body-l" || a.variant === "body",
      "dads-body-m": a.variant === "body-m",
      "dads-label": a.variant === "label-l" || a.variant === "label",
      "dads-label-m": a.variant === "label-m",
      "dads-caption": a.variant === "caption-l" || a.variant === "caption",
      "dads-caption-m": a.variant === "caption-m"
    })), (s, n) => a.variant === "h1" ? (t(), d("h1", h, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "h2" ? (t(), d("h2", y, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "h3" ? (t(), d("h3", b, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "h4" ? (t(), d("h4", m, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "h5" ? (t(), d("h5", _, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "body-l" || a.variant === "body" ? (t(), d("p", f, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "body-m" ? (t(), d("p", $, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "label-l" || a.variant === "label" ? (t(), d("p", k, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "label-m" ? (t(), d("p", C, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "caption-l" || a.variant === "caption" ? (t(), d("caption", B, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "caption-m" ? (t(), d("caption", g, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : a.variant === "body-m" ? (t(), d("p", z, [
      o(s.$slots, "default", {}, void 0, !0)
    ])) : (t(), d("p", T, [
      o(s.$slots, "default", {}, void 0, !0)
    ]));
  ...
  for (const [n, l] of a)
    s[n] = l;
  return s;
}, j = /* @__PURE__ */ E(D, [["__scopeId", "data-v-680a06a1"]]);
export {
  S as DadsButton,
  j as DadsTypography
};
